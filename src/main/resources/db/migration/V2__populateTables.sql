...
VALUES
    ('Tomislav', 'Tomašević', '1982-01-13', 'Ilica 1, 10000 Zagreb', '10000000000', 'hrvatsko', 'M'),
    ('Miroslav', 'Škoro', '1962-07-29', 'Trg bana Josipa Jelačića 3, 10000 Zagreb', '20000000000', 'hrvatsko', 'M'),
    ('Jelena', 'Pavičić Vukičević', '1975-09-02', 'Maksimirska cesta 34, 10000 Zagreb', '30000000000', 'hrvatsko', 'Ž'),
    ('Davor', 'Filipović', '1984-06-10', 'Savska cesta 66, 10000 Zagreb', '40000000000', 'hrvatsko', 'M'),
    ('Joško', 'Klisović', '1968-08-26', 'Jurišićeva ulica 19, 10000 Zagreb', '50000000000', 'hrvatsko', 'M'),
    ('Vesna', 'Škare Ožbolt', '1961-06-20', 'Palmotićeva ulica 22, 10000 Zagreb', '60000000000', 'hrvatsko', 'Ž'),
    ('Zvonimir', 'Troskot', '1984-10-05', 'Radnička cesta 80, 10000 Zagreb', '70000000000', 'hrvatsko', 'M'),
    ('Davor', 'Nađi', '1989-10-30', 'Nova cesta 7, 10000 Zagreb', '80000000000', 'hrvatsko', 'M'),
    ('Anka', 'Mrak-Taritaš', '1959-11-24', 'Petrinjska ulica 31, 10000 Zagreb', '90000000000', 'hrvatsko', 'Ž'),
    ('Željko', 'Tokić', '1970-01-01', 'Vukovarska ulica 64, 10000 Zagreb', '11111111111', 'hrvatsko', 'M'),
    ('Zoran', 'Milanović', '1966-10-30', 'Ulica grada Vukovara 269a, 10000 Zagreb', '22222222222', 'hrvatsko', 'M'),
    ('Kolinda', 'Grabar-Kitarović', '1968-04-29', 'Korzo 8, 51000 Rijeka', '33333333333', 'hrvatsko', 'Ž'),
    ('Mislav', 'Kolakušić', '1969-09-15', 'Splitska ulica 22, 21000 Split', '44444444444', 'hrvatsko', 'M'),
    ('Dario', 'Juričan', '1976-12-16', 'Ulica kralja Zvonimira 12, 23000 Zadar', '55555555555', 'hrvatsko', 'M'),
    ('Dalija', 'Orešković', '1977-06-18', 'Ulica Ivana Gundulića 4, 31000 Osijek', '66666666666', 'hrvatsko', 'Ž'),
    ('Ivan', 'Pernar', '1985-10-14', 'Obala Kneza Domagoja 1, 23000 Zadar', '77777777777', 'hrvatsko', 'M'),
    ('Katarina', 'Peović', '1974-11-16', 'Ulica Ante Starčevića 9, 21000 Split', '88888888888', 'hrvatsko', 'Ž'),
    ('Dejan', 'Kovač', '1984-01-01', 'Franjevački trg 1, 42000 Varaždin', '99999999999', 'hrvatsko', 'M'),
    ('Anto', 'Đapić', '1958-08-22', 'Ulica Matice hrvatske 15, 31000 Osijek', '11111111110', 'hrvatsko', 'M'),
    ('Nedjeljko', 'Babić', '1968-01-01', 'Ulica Nikole Tesle 8, 52100 Pula', '22222222220', 'hrvatsko', 'M'),
    ('Ivan', 'Horvat', '1980-01-01', 'Šetalište Ivana Meštrovića 5, 21000 Split', '12345678900', 'hrvatsko', 'M');
